...
//			return true;
		...
		case R.id.menu_qlog:
			...
			rec.pid = mPid;
			rec.category = mCat;
			rec.action = getString(R.string.atcion_kick);
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				adb.setPositiveButton(R.string.msg_confirm, new AlertDialog.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Utils.deleteRecord(RecordList.this, Long.toString(mRecordList.get(positionToRemove).time));
						mAdapter.updateList(Utils.getRecordListByCat(RecordList.this,  mCat));
						mAdapter.notifyDataSetChanged();
					}});
				adb.show();			
				return false;
